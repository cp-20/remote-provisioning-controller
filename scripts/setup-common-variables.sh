...
export RPC_NGINX_CONF_DIR_REPO="${PROJECT_ROOT:-/home/isucon/isucon14}/${SERVER_ID}/etc/nginx"
export RPC_NGINX_ACCESS_LOG_PATH="/var/log/nginx/access.log"

export RPC_DB_CONF_DIR_ORIGINAL="/etc/mysql"
export RPC_DB_CONF_DIR_REPO="${PROJECT_ROOT:-/home/isucon/isucon14}/${SERVER_ID}/etc/mysql"
...
export RPC_SYSTEMD_CONF_DIR_REPO="${PROJECT_ROOT:-/home/isucon/isucon14}/${SERVER_ID}/etc/systemd/system"

export RPC_APP_DIR_ORIGINAL="/home/isucon/webapp/go"
export RPC_APP_DIR_REPO="${PROJECT_ROOT:-/home/isucon/isucon14}/webapp/go"
